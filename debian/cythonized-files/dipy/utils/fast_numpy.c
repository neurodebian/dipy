 ...
 *         if number >= current:
 */
  for (__pyx_t_1 = (__pyx_v_size - 1); __pyx_t_1 > -1L; __pyx_t_1-=1) {
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initfast_numpy(void); /*proto*/
PyMODINIT_FUNC initfast_numpy(void)
#else
PyMODINIT_FUNC PyInit_fast_numpy(void); /*proto*/
PyMODINIT_FUNC PyInit_fast_numpy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_fast_numpy(void)", 0);
