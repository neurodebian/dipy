...
static const char __pyx_k_home_yoh_proj_nipy_nipy_suite_d[] = "/home/yoh/proj/nipy/nipy-suite/dipy/dipy/tracking/local/interpolation.pyx";
...
static const char __pyx_k_dipy_tracking_local_interpolatio[] = "dipy.tracking.local.interpolation";
 ...
 *     return data[index]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4dipy_8tracking_5local_13interpolation_3nearestneighbor_interpolate, NULL, __pyx_n_s_dipy_tracking_local_interpolatio); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
