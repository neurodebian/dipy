...
#define __PYX_HAVE__dipy__reconst__vec_val_sum
#define __PYX_HAVE_API__dipy__reconst__vec_val_sum
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'dipy.reconst.vec_val_sum' */
...
#define __Pyx_MODULE_NAME "dipy.reconst.vec_val_sum"
extern int __pyx_module_is_main_dipy__reconst__vec_val_sum;
int __pyx_module_is_main_dipy__reconst__vec_val_sum = 0;

/* Implementation of 'dipy.reconst.vec_val_sum' */
...
static const char __pyx_k_valr[] = "valr";
static const char __pyx_k_vals[] = "vals";
static const char __pyx_k_vecr[] = "vecr";
...
static const char __pyx_k_in_r_out_c[] = "in_r_out_c";
...
static const char __pyx_k_vec_val_vect[] = "vec_val_vect";
...
static PyObject *__pyx_kp_u_Vectorize_vecs_diag_vals_vecs_T;
...
static PyObject *__pyx_kp_s_dimensions_do_not_match;
static PyObject *__pyx_n_s_dipy_reconst_vec_val_sum;
static PyObject *__pyx_kp_s_dipy_reconst_vec_val_sum_pyx;
...
static PyObject *__pyx_n_s_in_r_out_c;
...
static PyObject *__pyx_n_s_valr;
static PyObject *__pyx_n_s_vals;
static PyObject *__pyx_n_s_vec;
static PyObject *__pyx_n_s_vec_val_vect;
static PyObject *__pyx_kp_u_vec_val_vect_line_8;
static PyObject *__pyx_n_s_vecr;
static PyObject *__pyx_n_s_vecs;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_4dipy_7reconst_11vec_val_sum_vec_val_vect(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_vecs, PyObject *__pyx_v_vals); /* proto */
...
/* "dipy/reconst/vec_val_sum.pyx":8
...
/* Python wrapper */
static PyObject *__pyx_pw_4dipy_7reconst_11vec_val_sum_1vec_val_vect(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4dipy_7reconst_11vec_val_sum_vec_val_vect[] = " Vectorize `vecs`.diag(`vals`).`vecs`.T for last 2 dimensions of `vecs`\n\n    Parameters\n    ----------\n    vecs : shape (..., M, N) array\n        containing tensor in last two dimensions; M, N usually equal to (3, 3)\n    vals : shape (..., N) array\n        diagonal values carried in last dimension, ``...`` shape above must\n        match that for `vecs`\n\n    Returns\n    -------\n    res : shape (..., M, M) array\n        For all the dimensions ellided by ``...``, loops to get (M, N) ``vec``\n        matrix, and (N,) ``vals`` vector, and calculates\n        ``vec.dot(np.diag(val).dot(vec.T)``.\n\n    Raises\n    ------\n    ValueError : non-matching ``...`` dimensions of `vecs`, `vals`\n    ValueError : non-matching ``N`` dimensions of `vecs`, `vals`\n\n    Examples\n    --------\n    Make a 3D array where the first dimension is only 1\n\n    >>> vecs = np.arange(9).reshape((1, 3, 3))\n    >>> vals = np.arange(3).reshape((1, 3))\n    >>> vec_val_vect(vecs, vals)\n    array([[[   9.,   24.,   39.],\n            [  24.,   66.,  108.],\n            [  39.,  108.,  177.]]])\n\n    That's the same as the 2D case (apart from the float casting):\n\n    >>> vecs = np.arange(9).reshape((3, 3))\n    >>> vals = np.arange(3)\n    >>> np.dot(vecs, np.dot(np.diag(vals), vecs.T))\n    array([[  9,  24,  39],\n           [ 24,  66, 108],\n           [ 39, 108, 177]])\n    ";
static PyMethodDef __pyx_mdef_4dipy_7reconst_11vec_val_sum_1vec_val_vect = {"vec_val_vect", (PyCFunction)__pyx_pw_4dipy_7reconst_11vec_val_sum_1vec_val_vect, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4dipy_7reconst_11vec_val_sum_vec_val_vect};
static PyObject *__pyx_pw_4dipy_7reconst_11vec_val_sum_1vec_val_vect(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_vecs = 0;
  PyObject *__pyx_v_vals = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("vec_val_vect (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_vecs,&__pyx_n_s_vals,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_vals)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("vec_val_vect", 1, 2, 2, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "vec_val_vect") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("vec_val_vect", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("dipy.reconst.vec_val_sum.vec_val_vect", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4dipy_7reconst_11vec_val_sum_vec_val_vect(__pyx_self, __pyx_v_vecs, __pyx_v_vals);
...
static PyObject *__pyx_pf_4dipy_7reconst_11vec_val_sum_vec_val_vect(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_vecs, PyObject *__pyx_v_vals) {
  npy_intp __pyx_v_t;
  npy_intp __pyx_v_N;
  ...
  npy_intp __pyx_v_r;
  npy_intp __pyx_v_c;
  npy_intp __pyx_v_in_r_out_c;
  __Pyx_memviewslice __pyx_v_vecr = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_valr = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  double __pyx_v_row_c;
  PyObject *__pyx_v_common_shape = NULL;
  ...
  int __pyx_t_32;
  __Pyx_RefNannySetupContext("vec_val_vect", 0);
  __Pyx_INCREF(__pyx_v_vecs);
  __Pyx_INCREF(__pyx_v_vals);

  /* "dipy/reconst/vec_val_sum.pyx":51
 *            [ 39, 108, 177]])
 *     """
 ...
 */
  ...
  if (!__pyx_t_2) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_v_vecs); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  ...
  /* "dipy/reconst/vec_val_sum.pyx":52
 *     """
 *     vecs = np.asarray(vecs)
 *     vals = np.asarray(vals)             # <<<<<<<<<<<<<<
 *     cdef:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_asarray); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  ...
  if (!__pyx_t_3) {
    __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_v_vals); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[2] = {__pyx_t_3, __pyx_v_vals};
    ...
    #endif
    {
      ...
      PyTuple_SET_ITEM(__pyx_t_2, 0+1, __pyx_v_vals);
  ...
  /* "dipy/reconst/vec_val_sum.pyx":64
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_vecs, __pyx_n_s_ndim); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "dipy/reconst/vec_val_sum.pyx":65
 *     # and Cython > 0.18
 *     ndim = vecs.ndim
 *     common_shape = vecs.shape[:(ndim-2)]             # <<<<<<<<<<<<<<
 *     rows, cols = vecs.shape[ndim-2], vecs.shape[ndim-1]
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_vecs, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_GetSlice(__pyx_t_1, 0, (__pyx_v_ndim - 2), NULL, NULL, NULL, 0, 1, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 65, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_common_shape = __pyx_t_4;
  __pyx_t_4 = 0;

  /* "dipy/reconst/vec_val_sum.pyx":66
 *     ndim = vecs.ndim
 *     common_shape = vecs.shape[:(ndim-2)]
 *     rows, cols = vecs.shape[ndim-2], vecs.shape[ndim-1]             # <<<<<<<<<<<<<<
 *     if vals.shape != common_shape + (cols,):
 ...
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_vecs, __pyx_n_s_shape); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = (__pyx_v_ndim - 2);
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_t_4, __pyx_t_6, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_5 = __Pyx_PyInt_As_Py_intptr_t(__pyx_t_1); if (unlikely((__pyx_t_5 == ((npy_intp)-1)) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_vecs, __pyx_n_s_shape); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_6 = (__pyx_v_ndim - 1);
  __pyx_t_4 = __Pyx_GetItemInt(__pyx_t_1, __pyx_t_6, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_7 = __Pyx_PyInt_As_Py_intptr_t(__pyx_t_4); if (unlikely((__pyx_t_7 == ((npy_intp)-1)) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_rows = __pyx_t_5;
  __pyx_v_cols = __pyx_t_7;

  /* "dipy/reconst/vec_val_sum.pyx":67
 *     common_shape = vecs.shape[:(ndim-2)]
 *     rows, cols = vecs.shape[ndim-2], vecs.shape[ndim-1]
 *     if vals.shape != common_shape + (cols,):             # <<<<<<<<<<<<<<
 *         raise ValueError('dimensions do not match')
 ...
 */
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_vals, __pyx_n_s_shape); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_1 = 0;
  __pyx_t_1 = PyNumber_Add(__pyx_v_common_shape, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_RichCompare(__pyx_t_4, __pyx_t_1, Py_NE); __Pyx_XGOTREF(__pyx_t_2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_t_2); if (unlikely(__pyx_t_8 < 0)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (unlikely(__pyx_t_8)) {

    /* "dipy/reconst/vec_val_sum.pyx":68
 *     rows, cols = vecs.shape[ndim-2], vecs.shape[ndim-1]
 *     if vals.shape != common_shape + (cols,):
 *         raise ValueError('dimensions do not match')             # <<<<<<<<<<<<<<
 *     N = np.prod(common_shape)
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "dipy/reconst/vec_val_sum.pyx":69
 *     if vals.shape != common_shape + (cols,):
 *         raise ValueError('dimensions do not match')
 *     N = np.prod(common_shape)             # <<<<<<<<<<<<<<
 *     vecr = np.array(vecs.reshape((N, rows, cols)), dtype=float)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_prod); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_4))) {
  ...
  if (!__pyx_t_1) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_v_common_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_4)) {
      PyObject *__pyx_temp[2] = {__pyx_t_1, __pyx_v_common_shape};
    ...
    #endif
    {
      ...
      __Pyx_INCREF(__pyx_v_common_shape);
      __Pyx_GIVEREF(__pyx_v_common_shape);
      PyTuple_SET_ITEM(__pyx_t_3, 0+1, __pyx_v_common_shape);
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_7 = __Pyx_PyInt_As_Py_intptr_t(__pyx_t_2); if (unlikely((__pyx_t_7 == ((npy_intp)-1)) && PyErr_Occurred())) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_N = __pyx_t_7;

  /* "dipy/reconst/vec_val_sum.pyx":70
 *         raise ValueError('dimensions do not match')
 *     N = np.prod(common_shape)
 *     vecr = np.array(vecs.reshape((N, rows, cols)), dtype=float)             # <<<<<<<<<<<<<<
 *     valr = np.array(vals.reshape((N, cols)), dtype=float)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_vecs, __pyx_n_s_reshape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_N); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_9 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_10 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = PyTuple_New(3); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  if (!__pyx_t_10) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_11); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 70, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, ((PyObject *)(&PyFloat_Type))) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_9, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_v_vecr = __pyx_t_12;
  __pyx_t_12.memview = NULL;
  __pyx_t_12.data = NULL;

  /* "dipy/reconst/vec_val_sum.pyx":71
 *     N = np.prod(common_shape)
 *     vecr = np.array(vecs.reshape((N, rows, cols)), dtype=float)
 *     valr = np.array(vals.reshape((N, cols)), dtype=float)             # <<<<<<<<<<<<<<
 *     out = np.zeros((N, rows, rows))
 *     with nogil:
 */
  __pyx_t_9 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_array); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_vals, __pyx_n_s_reshape); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_N); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_11 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  ...
  if (!__pyx_t_11) {
    __pyx_t_9 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_10); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 71, __pyx_L1_error)
    ...
    if (PyFunction_Check(__pyx_t_3)) {
      ...
      __pyx_t_9 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 71, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_11, __pyx_t_10};
      __pyx_t_9 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 71, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_10 = 0;
      __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, NULL); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 71, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_9);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    }
  }
  ...
  __Pyx_GOTREF(__pyx_t_9);
  if (PyDict_SetItem(__pyx_t_9, __pyx_n_s_dtype, ((PyObject *)(&PyFloat_Type))) < 0) __PYX_ERR(0, 71, __pyx_L1_error)
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_9); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_13 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_13.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_valr = __pyx_t_13;
  __pyx_t_13.memview = NULL;
  __pyx_t_13.data = NULL;

  /* "dipy/reconst/vec_val_sum.pyx":72
 *     vecr = np.array(vecs.reshape((N, rows, cols)), dtype=float)
 *     valr = np.array(vals.reshape((N, cols)), dtype=float)
 *     out = np.zeros((N, rows, rows))             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_N); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_2 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_10 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = PyTuple_New(3); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_GIVEREF(__pyx_t_9);
  ...
  if (!__pyx_t_10) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_11); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_10, __pyx_t_11};
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_10, __pyx_t_11};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_11 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_12 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_12.memview)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_out = __pyx_t_12;
  __pyx_t_12.memview = NULL;
  __pyx_t_12.data = NULL;

  /* "dipy/reconst/vec_val_sum.pyx":73
 *     valr = np.array(vals.reshape((N, cols)), dtype=float)
 *     out = np.zeros((N, rows, rows))
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for t in range(N): # loop over the early dimensions
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "dipy/reconst/vec_val_sum.pyx":74
 *     out = np.zeros((N, rows, rows))
 *     with nogil:
 *         for t in range(N): # loop over the early dimensions             # <<<<<<<<<<<<<<
 *             vec = vecr[t]
 ...
 */
        ...
        for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_5; __pyx_t_14+=1) {
          ...
          /* "dipy/reconst/vec_val_sum.pyx":75
 *     with nogil:
 *         for t in range(N): # loop over the early dimensions
 *             vec = vecr[t]             # <<<<<<<<<<<<<<
 *             val = valr[t]
 *             out_vec = out[t]
 */
          __pyx_t_13.data = __pyx_v_vecr.data;
          __pyx_t_13.memview = __pyx_v_vecr.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_13, 0);
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_vecr.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_vecr.strides[0];
...
__pyx_t_13.shape[0] = __pyx_v_vecr.shape[1];
__pyx_t_13.strides[0] = __pyx_v_vecr.strides[1];
    __pyx_t_13.suboffsets[0] = -1;

__pyx_t_13.shape[1] = __pyx_v_vecr.shape[2];
__pyx_t_13.strides[1] = __pyx_v_vecr.strides[2];
    __pyx_t_13.suboffsets[1] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_vec, 0);
          __pyx_v_vec = __pyx_t_13;
          __pyx_t_13.memview = NULL;
          __pyx_t_13.data = NULL;

          /* "dipy/reconst/vec_val_sum.pyx":76
 *         for t in range(N): # loop over the early dimensions
 *             vec = vecr[t]
 *             val = valr[t]             # <<<<<<<<<<<<<<
 *             out_vec = out[t]
 *             for r in range(rows):
 */
          __pyx_t_15.data = __pyx_v_valr.data;
          __pyx_t_15.memview = __pyx_v_valr.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_15, 0);
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_valr.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_valr.strides[0];
    if (0 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_15.shape[0] = __pyx_v_valr.shape[1];
__pyx_t_15.strides[0] = __pyx_v_valr.strides[1];
    __pyx_t_15.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_val, 0);
          __pyx_v_val = __pyx_t_15;
          __pyx_t_15.memview = NULL;
          __pyx_t_15.data = NULL;

          /* "dipy/reconst/vec_val_sum.pyx":77
 *             vec = vecr[t]
 *             val = valr[t]
 *             out_vec = out[t]             # <<<<<<<<<<<<<<
 *             for r in range(rows):
 *                 for c in range(cols):
 */
          __pyx_t_13.data = __pyx_v_out.data;
          __pyx_t_13.memview = __pyx_v_out.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_13, 0);
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_t;
...
__pyx_t_13.shape[0] = __pyx_v_out.shape[1];
__pyx_t_13.strides[0] = __pyx_v_out.strides[1];
    __pyx_t_13.suboffsets[0] = -1;

__pyx_t_13.shape[1] = __pyx_v_out.shape[2];
__pyx_t_13.strides[1] = __pyx_v_out.strides[2];
    __pyx_t_13.suboffsets[1] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_out_vec, 0);
          __pyx_v_out_vec = __pyx_t_13;
          __pyx_t_13.memview = NULL;
          __pyx_t_13.data = NULL;

          /* "dipy/reconst/vec_val_sum.pyx":78
 *             val = valr[t]
 *             out_vec = out[t]
 *             for r in range(rows):             # <<<<<<<<<<<<<<
 *                 for c in range(cols):
 ...
 */
          ...
          for (__pyx_t_18 = 0; __pyx_t_18 < __pyx_t_17; __pyx_t_18+=1) {
            ...
            /* "dipy/reconst/vec_val_sum.pyx":79
 *             out_vec = out[t]
 *             for r in range(rows):
 *                 for c in range(cols):             # <<<<<<<<<<<<<<
 *                     row_c = vec[r, c] * val[c]
 ...
 */
            __pyx_t_19 = __pyx_v_cols;
            __pyx_t_20 = __pyx_t_19;
            for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_20; __pyx_t_21+=1) {
              __pyx_v_c = __pyx_t_21;

              /* "dipy/reconst/vec_val_sum.pyx":80
 *             for r in range(rows):
 *                 for c in range(cols):
 *                     row_c = vec[r, c] * val[c]             # <<<<<<<<<<<<<<
 *                     for in_r_out_c in range(rows):
 ...
 */
              ...
              __pyx_v_row_c = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_22 * __pyx_v_vec.strides[0]) ) + __pyx_t_23 * __pyx_v_vec.strides[1]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_val.data + __pyx_t_24 * __pyx_v_val.strides[0]) ))));

              /* "dipy/reconst/vec_val_sum.pyx":81
 *                 for c in range(cols):
 *                     row_c = vec[r, c] * val[c]
 *                     for in_r_out_c in range(rows):             # <<<<<<<<<<<<<<
 *                         out_vec[r, in_r_out_c] += row_c * vec[in_r_out_c, c]
 ...
 */
              __pyx_t_25 = __pyx_v_rows;
              __pyx_t_26 = __pyx_t_25;
              for (__pyx_t_27 = 0; __pyx_t_27 < __pyx_t_26; __pyx_t_27+=1) {
                __pyx_v_in_r_out_c = __pyx_t_27;

                /* "dipy/reconst/vec_val_sum.pyx":82
 *                     row_c = vec[r, c] * val[c]
 *                     for in_r_out_c in range(rows):
 *                         out_vec[r, in_r_out_c] += row_c * vec[in_r_out_c, c]             # <<<<<<<<<<<<<<
 *     return np.reshape(out, (common_shape + (rows, rows)))
 */
                __pyx_t_28 = __pyx_v_in_r_out_c;
                __pyx_t_29 = __pyx_v_c;
                __pyx_t_30 = __pyx_v_r;
                __pyx_t_31 = __pyx_v_in_r_out_c;
                *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out_vec.data + __pyx_t_30 * __pyx_v_out_vec.strides[0]) ) + __pyx_t_31 * __pyx_v_out_vec.strides[1]) )) += (__pyx_v_row_c * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_28 * __pyx_v_vec.strides[0]) ) + __pyx_t_29 * __pyx_v_vec.strides[1]) ))));
              }
            }
          }
        }
 ...
 */
  ...
  /* "dipy/reconst/vec_val_sum.pyx":83
 *                     for in_r_out_c in range(rows):
 *                         out_vec[r, in_r_out_c] += row_c * vec[in_r_out_c, c]
 *     return np.reshape(out, (common_shape + (rows, rows)))             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_reshape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_out, 3, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_11 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_10 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  ...
  __pyx_t_11 = 0;
  __pyx_t_10 = 0;
  __pyx_t_10 = PyNumber_Add(__pyx_v_common_shape, __pyx_t_9); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 83, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = NULL;
  __pyx_t_32 = 0;
  ...
  if (PyFunction_Check(__pyx_t_2)) {
    ...
    __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_32, 2+__pyx_t_32); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 83, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
    PyObject *__pyx_temp[3] = {__pyx_t_9, __pyx_t_3, __pyx_t_10};
    __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-__pyx_t_32, 2+__pyx_t_32); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 83, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
  ...
  #endif
  {
    __pyx_t_11 = PyTuple_New(2+__pyx_t_32); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 83, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_11);
    if (__pyx_t_9) {
      __Pyx_GIVEREF(__pyx_t_9); PyTuple_SET_ITEM(__pyx_t_11, 0, __pyx_t_9); __pyx_t_9 = NULL;
    }
    __Pyx_GIVEREF(__pyx_t_3);
    PyTuple_SET_ITEM(__pyx_t_11, 0+__pyx_t_32, __pyx_t_3);
    __Pyx_GIVEREF(__pyx_t_10);
    PyTuple_SET_ITEM(__pyx_t_11, 1+__pyx_t_32, __pyx_t_10);
    __pyx_t_3 = 0;
    __pyx_t_10 = 0;
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_11, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 83, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_vecr, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_valr, 1);
 ...
 *         if itemsize <= 0:
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__11, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 132, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple__13, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 138, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 * 
 */
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__14, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 147, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
      __pyx_t_10 = __Pyx_PyObject_Call(__pyx_builtin_MemoryError, __pyx_tuple__15, NULL); if (unlikely(!__pyx_t_10)) __PYX_ERR(2, 175, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_Raise(__pyx_t_10, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
 ...
 *         info.len = self.len
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__16, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 191, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_TypeError, __pyx_tuple__19, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 413, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *             if len(self.view.format) == 1:
 */
      __pyx_t_6 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__20, NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(2, 490, __pyx_L5_except_error)
      __Pyx_GOTREF(__pyx_t_6);
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__21, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 515, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_Raise(__pyx_t_3, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__22, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(2, 565, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_Raise(__pyx_t_2, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyNumber_Multiply(__pyx_tuple__23, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 572, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "dipy.reconst.vec_val_sum.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "dipy.reconst.vec_val_sum.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "dipy.reconst.vec_val_sum.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "dipy.reconst.vec_val_sum._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_vec_val_sum(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_vec_val_sum},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_Vectorize_vecs_diag_vals_vecs_T, __pyx_k_Vectorize_vecs_diag_vals_vecs_T, sizeof(__pyx_k_Vectorize_vecs_diag_vals_vecs_T), 0, 1, 0, 0},
  ...
  {&__pyx_kp_s_dimensions_do_not_match, __pyx_k_dimensions_do_not_match, sizeof(__pyx_k_dimensions_do_not_match), 0, 0, 1, 0},
  {&__pyx_n_s_dipy_reconst_vec_val_sum, __pyx_k_dipy_reconst_vec_val_sum, sizeof(__pyx_k_dipy_reconst_vec_val_sum), 0, 0, 1, 1},
  {&__pyx_kp_s_dipy_reconst_vec_val_sum_pyx, __pyx_k_dipy_reconst_vec_val_sum_pyx, sizeof(__pyx_k_dipy_reconst_vec_val_sum_pyx), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_in_r_out_c, __pyx_k_in_r_out_c, sizeof(__pyx_k_in_r_out_c), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_valr, __pyx_k_valr, sizeof(__pyx_k_valr), 0, 0, 1, 1},
  {&__pyx_n_s_vals, __pyx_k_vals, sizeof(__pyx_k_vals), 0, 0, 1, 1},
  {&__pyx_n_s_vec, __pyx_k_vec, sizeof(__pyx_k_vec), 0, 0, 1, 1},
  {&__pyx_n_s_vec_val_vect, __pyx_k_vec_val_vect, sizeof(__pyx_k_vec_val_vect), 0, 0, 1, 1},
  {&__pyx_kp_u_vec_val_vect_line_8, __pyx_k_vec_val_vect_line_8, sizeof(__pyx_k_vec_val_vect_line_8), 0, 1, 0, 0},
  {&__pyx_n_s_vecr, __pyx_k_vecr, sizeof(__pyx_k_vecr), 0, 0, 1, 1},
 ...
 *     vecr = np.array(vecs.reshape((N, rows, cols)), dtype=float)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_dimensions_do_not_match); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 68, __pyx_L1_error)
 ...
 *         if itemsize <= 0:
 */
  __pyx_tuple__11 = PyTuple_Pack(1, __pyx_kp_s_Empty_shape_tuple_for_cython_arr); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(2, 132, __pyx_L1_error)
 ...
 *         if not isinstance(format, bytes):
 */
  __pyx_tuple__12 = PyTuple_Pack(1, __pyx_kp_s_itemsize_0_for_cython_array); if (unlikely(!__pyx_tuple__12)) __PYX_ERR(2, 135, __pyx_L1_error)
 ...
 *         self.format = self._format
 */
  __pyx_tuple__13 = PyTuple_Pack(1, __pyx_n_s_ASCII); if (unlikely(!__pyx_tuple__13)) __PYX_ERR(2, 138, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__14 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_shape_and_str); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(2, 147, __pyx_L1_error)
 ...
 *             if self.dtype_is_object:
 */
  __pyx_tuple__15 = PyTuple_Pack(1, __pyx_kp_s_unable_to_allocate_array_data); if (unlikely(!__pyx_tuple__15)) __PYX_ERR(2, 175, __pyx_L1_error)
 ...
 *         info.len = self.len
 */
  __pyx_tuple__16 = PyTuple_Pack(1, __pyx_kp_s_Can_only_create_a_buffer_that_is); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(2, 191, __pyx_L1_error)
 ...
 *         have_slices, index = _unellipsify(index, self.view.ndim)
 */
  __pyx_tuple__19 = PyTuple_Pack(1, __pyx_kp_s_Cannot_assign_to_read_only_memor); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(2, 413, __pyx_L1_error)
 ...
 *             if len(self.view.format) == 1:
 */
  __pyx_tuple__20 = PyTuple_Pack(1, __pyx_kp_s_Unable_to_convert_item_to_object); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(2, 490, __pyx_L1_error)
 ...
 *         if flags & PyBUF_STRIDES:
 */
  __pyx_tuple__21 = PyTuple_Pack(1, __pyx_kp_s_Cannot_create_writable_memory_vi); if (unlikely(!__pyx_tuple__21)) __PYX_ERR(2, 515, __pyx_L1_error)
 ...
 *         return tuple([stride for stride in self.view.strides[:self.view.ndim]])
 */
  __pyx_tuple__22 = PyTuple_Pack(1, __pyx_kp_s_Buffer_view_does_not_expose_stri); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(2, 565, __pyx_L1_error)
 ...
 *         return tuple([suboffset for suboffset in self.view.suboffsets[:self.view.ndim]])
 */
  __pyx_tuple__23 = PyTuple_New(1); if (unlikely(!__pyx_tuple__23)) __PYX_ERR(2, 572, __pyx_L1_error)
 ...
 *             else:
 */
  __pyx_slice__26 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__26)) __PYX_ERR(2, 677, __pyx_L1_error)
 ...
 *     return have_slices or nslices, tuple(result)
 */
  __pyx_slice__28 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__28)) __PYX_ERR(2, 691, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__29 = PyTuple_Pack(1, __pyx_kp_s_Indirect_dimensions_not_supporte); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(2, 698, __pyx_L1_error)
 ...
 * 
 */
  __pyx_tuple__32 = PyTuple_Pack(18, __pyx_n_s_vecs, __pyx_n_s_vals, __pyx_n_s_t, __pyx_n_s_N, __pyx_n_s_ndim, __pyx_n_s_rows, __pyx_n_s_cols, __pyx_n_s_r, __pyx_n_s_c, __pyx_n_s_in_r_out_c, __pyx_n_s_vecr, __pyx_n_s_valr, __pyx_n_s_vec, __pyx_n_s_out_vec, __pyx_n_s_val, __pyx_n_s_out, __pyx_n_s_row_c, __pyx_n_s_common_shape); if (unlikely(!__pyx_tuple__32)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__32);
  __Pyx_GIVEREF(__pyx_tuple__32);
  __pyx_codeobj__33 = (PyObject*)__Pyx_PyCode_New(2, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__32, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dipy_reconst_vec_val_sum_pyx, __pyx_n_s_vec_val_vect, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__33)) __PYX_ERR(0, 8, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initvec_val_sum(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initvec_val_sum(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_vec_val_sum(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_vec_val_sum(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_vec_val_sum(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_vec_val_sum(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("vec_val_sum", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_dipy__reconst__vec_val_sum) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dipy.reconst.vec_val_sum")) {
      if (unlikely(PyDict_SetItemString(modules, "dipy.reconst.vec_val_sum", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "dipy/reconst/vec_val_sum.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4dipy_7reconst_11vec_val_sum_1vec_val_vect, NULL, __pyx_n_s_dipy_reconst_vec_val_sum); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_vec_val_vect, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_vec_val_vect_line_8, __pyx_kp_u_Vectorize_vecs_diag_vals_vecs_T) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dipy.reconst.vec_val_sum", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dipy.reconst.vec_val_sum");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
